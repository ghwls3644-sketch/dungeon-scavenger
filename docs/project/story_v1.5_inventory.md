...
| STY-0009 | 2 | 이 파트의 추가 검토 메모 | 83-89 | `project/open_questions.md` | `review` | moved |
...
| STY-0016 | 2 | 이 파트의 추가 검토 메모 | 144-150 | `project/open_questions.md` | `review` | moved |
...
| STY-0023 | 2 | 이 파트의 추가 검토 메모 | 209-215 | `project/open_questions.md` | `review` | moved |
...
| STY-0030 | 2 | 이 파트의 추가 검토 메모 | 284-290 | `project/open_questions.md` | `review` | moved |
...
| STY-0035 | 2 | 이 파트의 추가 검토 메모 | 331-337 | `project/open_questions.md` | `review` | moved |
...
| STY-0043 | 2 | 이 파트의 추가 검토 메모 | 405-411 | `project/open_questions.md` | `review` | moved |
...
| STY-0052 | 2 | 이 파트의 추가 검토 메모 | 503-509 | `project/open_questions.md` | `review` | moved |
...
| STY-0059 | 2 | 이 파트의 추가 검토 메모 | 583-589 | `project/open_questions.md` | `review` | moved |
...
| STY-0066 | 2 | 이 파트의 추가 검토 메모 | 654-660 | `project/open_questions.md` | `review` | moved |
...
| STY-0075 | 2 | 이 파트의 추가 검토 메모 | 759-765 | `project/open_questions.md` | `review` | moved |
...
| STY-0085 | 2 | 이 파트의 추가 검토 메모 | 885-891 | `project/open_questions.md` | `review` | moved |
...
| STY-0093 | 2 | 이 파트의 추가 검토 메모 | 961-967 | `project/open_questions.md` | `review` | moved |
