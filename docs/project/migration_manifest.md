...
| `도달` | `DEV-0006` 완료 후 | 프로젝트 기반·테스트·로그·디버그 진입점의 일치를 확인한 뒤 G0 통과와 `DEV-0101` 시작 여부 검토 |
...
현재 다음 절차는 G0 정합성 검사다. 검사 결과를 확인하고 사용자가 계속 진행하라고 지시한 뒤 `DEV-0101 — 플레이어 이동과 카메라`를 시작한다.
