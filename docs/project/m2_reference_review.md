...
| R-M2-005 | `STY-0101` | 누락 추적 | 13장의 추가 검토 메모는 내용 확정 대상이 아니라 [`open_questions.md`](open_questions.md) 이관 대상으로 등록되어 있다. | 낮음 | `DOC-0402`에서 질문·보류 항목과 기존 결정 대응으로 이관했다. |
...
| 이 파트의 추가 검토 메모 | `STY-0101` | Open Questions 질문·원본 대응표로 `moved` |
...
- 후속 처리: `STY-0101`의 추가 검토 메모는 `DOC-0402`에서 Open Questions로 이관했다.
- 후속 티켓: `DOC-0201`; 상세 연결 보강은 `DOC-0203`, `DOC-0205`, `DOC-0207`; 미결정 사항 이관은 `DOC-0402`에서 완료
